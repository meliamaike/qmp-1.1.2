...
# esto lo hago para poder traerme las categorias del prenda tipo
  def prendas_cabeza
    # self.prendas.select{|prenda| prenda.prenda_tipo_id.categoria.to_sym == :cabeza}
  ...
  def prendas_torso
# self.prendas.select{|prenda| prenda.prenda_tipo_id.categoria.to_sym == :torso}
  ...
  def prendas_piernas
    ...
    # self.prendas.select{|prenda| prenda.prenda_tipo_id.categoria.to_sym == :piernas}
    self.prendas.select{|prenda| prenda.prenda_tipo.categoria=="piernas"}
  end
  def prendas_pies
    #self.prendas.select{|prenda| prenda.prenda_tipo_id.categoria.to_sym == :pies}
